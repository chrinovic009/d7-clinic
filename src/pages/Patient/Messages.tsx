          ...
          {(isDesktop || showConversation) && (
            <div className="flex min-h-[640px] flex-col rounded-3xl border border-gray-200 bg-slate-50 dark:border-gray-800 dark:bg-slate-950">
              ...
              <div className="flex items-center gap-4">
                ...
                <button title="Appel" className="rounded-2xl bg-white p-2 text-sm font-medium text-gray-600 shadow-sm transition hover:bg-gray-100 dark:bg-slate-900 dark:text-gray-200 dark:hover:bg-slate-800">
                  <AudioIcon className="h-5 w-5" />
                </button>
                <button title="Vidéo" className="rounded-2xl bg-white p-2 text-sm font-medium text-gray-600 shadow-sm transition hover:bg-gray-100 dark:bg-slate-900 dark:text-gray-200 dark:hover:bg-slate-800">
