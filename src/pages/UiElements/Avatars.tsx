...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | D7 Clinique - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for D7 Clinique - React.js Tailwind CSS Admin Dashboard Template"
      />
